...
# 已转换为[224, 224, 3]图像
INPUT_DATA = './flower_processed_data_vgg.npy'
TRAIN_FILE = './save_model/vgg16'
SAVE_PATH = './save_model/'
# https://github.com/tensorflow/models/tree/master/research/slim
TRAINED_CKPT_FILE = './vgg_16.ckpt'
...
CHECKPOINT_EXCLUDE_SCOPE = 'vgg_16/fc8'
# 需要训练的模型参数
TRAINABLE_SCOPE = CHECKPOINT_EXCLUDE_SCOPE


# 获取谷歌训练好的 vgg 模型参数, 排除要重新训练的最后一层
...
def main(argv=None):
    ...
    # 损失函数
    loss_fun = tf.losses.softmax_cross_entropy(tf.one_hot(labels, N_CLASSES), logits)
    # 训练
