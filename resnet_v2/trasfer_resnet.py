...
# 已转换为[224, 224, 3]图像
INPUT_DATA = '../8.1vgg/flower_processed_data_vgg.npy'
TRAIN_FILE = './save_model/resnetv2_50'
SAVE_PATH = './save_model/'
# https://github.com/tensorflow/models/tree/master/research/slim
TRAINED_CKPT_FILE = './resnet_v2_50.ckpt'
...
CHECKPOINT_EXCLUDE_SCOPE = 'resnet_v2_50/logits'
# 需要训练的模型参数
